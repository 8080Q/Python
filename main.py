...
class FirstFrame(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.btn_stu = Button(self, text='学生成绩查询系统', width=18, height=1, bg='white', font=('黑体', 15))
        self.btn_adm = Button(self, text='学生成绩管理系统', width=18, height=1, bg='white', font=('黑体', 15))
...
class RegisterFrame(Frame):
    ...
    def __init__(self, master=None, TypeChoice=None):  # TypeChoice 用于判断学生查询界面或管理员登录界面
        ...
        self.btn_cfm = Button(self, text='确定', width=8, height=1, bg='white', font=('黑体', 15))
        self.btn_cnc = Button(self, text='清空', width=8, height=1, bg='white', font=('黑体', 15))
        self.btn_rtn = Button(self, text='返回', width=8, height=1, bg='white', font=('黑体', 15))
